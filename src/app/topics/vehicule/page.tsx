...
export default async function VehiculePage() {
  ...
  const topic = {
    title: 'Véhicule',
    icon: '🚙',
    tldr: 'Gérer votre véhicule : contrôle technique, assurance, carte grise, révisions.',
    checklist: [
      'Assurer votre véhicule',
      'Effectuer le contrôle technique',
      'Faire les révisions régulières',
      'Conserver la carte grise',
    ],
    faq: [
      {
        question: 'Quand faire le contrôle technique ?',
        answer: 'Le premier contrôle technique doit être effectué dans les 6 mois précédant le 4ème anniversaire du véhicule, puis tous les 2 ans.',
      },
    ],
    resources: [
      { name: 'Service-Public - Véhicule', url: 'https://www.service-public.fr' },
    ],
  }
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="relative bg-gradient-to-br from-slate-600 to-gray-600 rounded-[2rem] p-6 text-white overflow-hidden">
