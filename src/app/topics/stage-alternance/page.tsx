...
export default async function StageAlternancePage() {
  ...
  const topicSlug = 'stage-alternance'
  ...
  const topic = {
    ...
    icon: '💼',
    tldr: 'Gérer vos stages et contrats d\'alternance. Connaître vos droits et obligations.',
    checklist: [
    ...
    faq: [
      {
        ...
        answer: 'La durée maximale d\'un stage est de 6 mois par année d\'enseignement. Au-delà de 2 mois, le stage doit être rémunéré.',
      },
    ],
    resources: [
      { name: 'Service-Public - Stage', url: 'https://www.service-public.fr' },
    ],
  }
