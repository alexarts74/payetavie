...
export default async function InscriptionsEtudiantesPage() {
  ...
  const topicSlug = 'inscriptions-etudiantes'
  ...
  const topic = {
    title: 'Inscriptions',
    icon: '📝',
    tldr: 'Gérer vos inscriptions universitaires, Parcoursup et autres démarches d\'inscription.',
    checklist: [
    ...
    faq: [
      {
        question: 'Quand s\'inscrire à l\'université ?',
        answer: 'Les inscriptions se font généralement entre juillet et septembre. Vérifiez les dates spécifiques sur le site de votre établissement.',
      },
    ],
    resources: [
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="relative bg-gradient-to-br from-indigo-600 to-blue-600 rounded-[2rem] p-6 text-white overflow-hidden">
