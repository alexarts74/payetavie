...
export default async function CongesRttPage() {
  ...
  const topic = {
    title: 'Congés & RTT',
    icon: '🏖️',
    tldr: 'Gérer vos congés payés et RTT, connaître vos droits et obligations.',
    checklist: [
      'Connaître votre solde de congés',
      'Respecter les délais de demande',
      'Planifier vos congés à l\'avance',
    ],
    faq: [
      {
        question: 'Combien de jours de congés payés par an ?',
        answer: 'En France, vous avez droit à 2,5 jours ouvrables de congés payés par mois de travail effectif, soit 30 jours (5 semaines) par an.',
      },
    ],
    resources: [
      { name: 'Service-Public - Congés payés', url: 'https://www.service-public.fr' },
    ],
  }
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="relative bg-gradient-to-br from-orange-600 to-amber-600 rounded-[2rem] p-6 text-white overflow-hidden">
