...
export default async function CoursExamensPage() {
  ...
  const topic = {
    title: 'Cours & Examens',
    icon: '📚',
    tldr: 'Organiser vos cours, révisions et examens. Suivre votre emploi du temps et vos deadlines.',
    checklist: [
      'Organiser votre emploi du temps',
      'Planifier vos révisions',
      'Noter les dates d\'examens',
      'Préparer vos documents pour les examens',
    ],
    faq: [
      {
        question: 'Comment bien organiser mes révisions ?',
        answer: 'Planifiez vos révisions à l\'avance, créez un planning, alternez les matières, faites des pauses régulières et testez-vous régulièrement.',
      },
    ],
    resources: [
      { name: 'Parcoursup', url: 'https://www.parcoursup.fr' },
    ],
  }
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="relative bg-gradient-to-br from-amber-600 to-orange-600 rounded-[2rem] p-6 text-white overflow-hidden">
