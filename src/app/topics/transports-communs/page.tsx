...
export default async function TransportsCommunsPage() {
  ...
  const topicSlug = 'transports-communs'
  ...
  const topic = {
    ...
    icon: '🚌',
    tldr: 'Gérer vos abonnements de transports en commun : Navigo, cartes de transport, réductions.',
    checklist: [
    ...
    faq: [
      {
        question: 'Comment obtenir une réduction pour les transports ?',
        answer: 'Des réductions sont disponibles pour les étudiants, les seniors, les personnes en situation de handicap. Renseignez-vous auprès de votre réseau de transport.',
      },
    ],
    resources: [
      { name: 'Île-de-France Mobilités', url: 'https://www.iledefrance-mobilites.fr' },
    ],
  }
