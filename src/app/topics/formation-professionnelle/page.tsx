...
export default async function FormationProfessionnellePage() {
  ...
  const topicSlug = 'formation-professionnelle'
  ...
  const topic = {
    ...
    icon: '🎓',
    tldr: 'Utiliser votre CPF, trouver des formations et développer vos compétences professionnelles.',
    checklist: [
      'Vérifier votre solde CPF',
      'Rechercher des formations',
      'Demander l\'accord de votre employeur si nécessaire',
    ],
    faq: [
      {
        question: 'Qu\'est-ce que le CPF ?',
        answer: 'Le Compte Personnel de Formation (CPF) permet d\'acquérir des droits à la formation mobilisables tout au long de la vie professionnelle.',
      },
    ],
    resources: [
      { name: 'Mon Compte Formation', url: 'https://www.moncompteformation.gouv.fr' },
    ],
  }
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="relative bg-gradient-to-br from-violet-600 to-purple-600 rounded-[2rem] p-6 text-white overflow-hidden">
