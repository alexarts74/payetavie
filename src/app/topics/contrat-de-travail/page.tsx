...
export default async function ContratDeTravailPage() {
  ...
  const topicSlug = 'contrat-de-travail'
  ...
  const topic = {
    ...
    icon: '📄',
    tldr: 'Comprendre votre contrat de travail, vos droits et obligations.',
    checklist: [
    ...
    faq: [
      {
        question: 'Quels sont les différents types de contrats de travail ?',
        answer: 'Les principaux types sont : CDI (Contrat à Durée Indéterminée), CDD (Contrat à Durée Déterminée), contrat d\'intérim, contrat d\'apprentissage, contrat de professionnalisation.',
      },
    ],
    resources: [
      { name: 'Service-Public - Contrat de travail', url: 'https://www.service-public.fr' },
    ],
  }
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="relative bg-gradient-to-br from-indigo-600 to-purple-600 rounded-[2rem] p-6 text-white overflow-hidden">
