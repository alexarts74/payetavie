...
export default async function ChomagePage() {
  ...
  const topic = {
    title: 'Chômage',
    icon: '📋',
    tldr: 'Comprendre les démarches pour s\'inscrire à Pôle Emploi et bénéficier des allocations chômage.',
    checklist: [
      'S\'inscrire à Pôle Emploi',
      'Faire votre demande d\'allocation',
      'Effectuer vos actualisations',
      'Rechercher activement un emploi',
    ],
    faq: [
      {
        question: 'Comment s\'inscrire à Pôle Emploi ?',
        answer: 'L\'inscription peut se faire en ligne sur pole-emploi.fr ou dans une agence. Il faut créer un compte et compléter votre profil.',
      },
    ],
    resources: [
